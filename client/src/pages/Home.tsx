...
const headlineLine: Variants = { hidden: { opacity: 0, y: 38, rotateX: -42 }, show: { opacity: 1, y: 0, rotateX: 0, transition: { duration: 0.75, ease: "easeOut" } } };
...
export default function Home() {
  ...
  return <div className="grain-overlay min-h-screen overflow-x-hidden bg-[#f8f5ef] text-[#1c1a2c]">
    ...
    <main id="top"><section className="hero-section hero-section-real"><div className="hero-canvas-layer"><Suspense fallback={null}><HeroScene /></Suspense></div><div className="hero-grid container"><div className="hero-copy"><motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: "easeOut" }} className="eyebrow"><span className="eyebrow-dot" /> Sri Lanka’s student-powered library</motion.div><motion.h1 initial="hidden" animate="show" variants={{ hidden: {}, show: { transition: { staggerChildren: 0.16, delayChildren: 0.1 } } }}><motion.span variants={headlineLine} className="headline-line">Share the note.</motion.span><br /><motion.em variants={headlineLine} className="headline-line">Change the next study session.</motion.em></motion.h1><motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, delay: 0.5, ease: "easeOut" }} className="hero-description">Kuppi is a real, growing space for students to exchange useful files, find better explanations, and make studying less lonely.</motion.p><motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, delay: 0.62, ease: "easeOut" }} className="flex flex-wrap gap-3"><Button onClick={() => document.getElementById("feed")?.scrollIntoView({ behavior: "smooth" })} className="h-12 rounded-full bg-[#5b35e8] px-6 font-bold text-white hover:bg-[#4827cf]">Browse resources <ArrowRight size={17} /></Button><Button onClick={() => requireStudent(() => setShowUpload(true))} variant="outline" className="h-12 rounded-full border-[#d8d0c7] bg-transparent px-6 font-bold text-[#292639] hover:bg-white"><Upload size={17} /> Share a resource</Button></motion.div><motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.78 }} className="real-library-note"><Check size={15} /> No placeholders. Every listed resource comes from a Kuppi student.</motion.p></div><motion.div initial={{ opacity: 0, scale: 0.94, y: 18 }} animate={{ opacity: 1, scale: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.3, ease: [0.22, 0.65, 0.3, 1] }} className="real-hero-art"><div className="real-file-stack"><div className="hero-file hero-file-back"><File size={30} /><span>YOUR USEFUL FILE</span></div><div className="hero-file hero-file-mid"><FileText size={32} /><strong>Notes that<br />move forward.</strong></div><div className="hero-file hero-file-front"><div><span className="brand-orb"><span /></span><b>Kuppi</b></div><p>Share what helped you understand.</p><div className="hero-file-lines"><i /><i /><i /></div><small><Upload size={13} /> Real student uploads</small></div></div></motion.div></div></section>
